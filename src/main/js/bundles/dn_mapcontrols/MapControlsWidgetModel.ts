...
class MapControlsWidgetModel extends Mutable {
}

interface MapControlsWidgetModelProps {
    rightClickActive: boolean;
}

export default defineProperties<MapControlsWidgetModel, MapControlsWidgetModelProps>(MapControlsWidgetModel,
    {
